...
class ToneColorConverter(OpenVoiceBaseClass):
    def __init__(self, *args, **kwargs):
        ...
        if kwargs.get('enable_watermark', True):
            import wavmark
            filepath='OpenVoice-main/WavMark/step59000_snr39.99_pesq4.35_BERP_none0.30_mean1.81_std1.81.model.pkl'
            self.watermark_model = wavmark.load_model(filepath).to(self.device)
        else:
