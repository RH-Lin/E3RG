...
DOWNLOAD_CKPT_URLS = {
    'EN_NEWEST': 'MeloTTS-main/myshell-ai/MeloTTS-English-v3/checkpoint.pth',
    'ZH': 'MeloTTS-main/myshell-ai/MeloTTS-Chinese/checkpoint.pth'
}

DOWNLOAD_CONFIG_URLS_ORIGIN = {
...
DOWNLOAD_CONFIG_URLS = {
    'EN_NEWEST': 'MeloTTS-main/myshell-ai/MeloTTS-English-v3/config.json',
    'ZH': 'MeloTTS-main/myshell-ai/MeloTTS-Chinese/config.json'
}
